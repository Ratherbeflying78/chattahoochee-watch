...
| **Water Quality** | Built around a pan-and-zoom map of the Chattahoochee Riverkeeper sampling sites that sit on the lake or the mainstem river itself — the small feeder creeks Riverkeeper also samples are filtered off the map, since a hot reading a mile up an urban creek says nothing about the water you swim in. Sites are coloured by their latest lab-cultured E. coli result and switchable between the West Point Lake reach and the whole corridor, with clustered markers that carry the worst result they contain. Below it: live USGS BacteriALERT estimates at Atlanta and Norcross against the 235 cfu/100 mL contact-recreation threshold, the same Riverkeeper samples as tables (the basin-wide tables still include creeks), plus turbidity, dissolved oxygen and pH. |
